...
namespace Vesna.Forms {
	partial class MainForm {
		...
		private void InitializeComponent() {
			...
			this.menuStrip1.Items.AddRange(new System.Windows.Forms.ToolStripItem[] { this.файлToolStripMenuItem, this.базаToolStripMenuItem, this.DocToolStripMenuItem });
			...
			// 
			this.файлToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.новоеТСToolStripMenuItem, this.выходToolStripMenuItem });
			...
			this.базаToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[]
				                                                  { this.открытьБазуToolStripMenuItem, this.справочникиToolStripMenuItem1, this.настройкиToolStripMenuItem, this.m_runAsAdmin });
			...
			this.b_calc.Location = new System.Drawing.Point(14, 625);
			this.b_calc.Name = "b_calc";
			this.b_calc.Size = new System.Drawing.Size(157, 37);
			...
			this.b_act.Location = new System.Drawing.Point(199, 625);
			this.b_act.Name = "b_act";
			this.b_act.Size = new System.Drawing.Size(157, 37);
			...
			this.wheelListControl.Location = new System.Drawing.Point(10, 31);
			this.wheelListControl.Name = "wheelListControl";
			this.wheelListControl.Size = new System.Drawing.Size(1429, 587);
			...
			this.ClientSize = new System.Drawing.Size(1462, 675);
		...
		private Vesna.Controls.WheelListControl wheelListControl;
	}
}